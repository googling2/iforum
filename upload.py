...
#     usercode = user.get("usercode") if user else None  # 세션에서 usercode를 가져옴
...
#     print(user_credentials.refresh_token)

#     try:
#         youtube = get_authenticated_service(user_credentials)
#         print("youtube", youtube)

#         options = Namespace(
#             file="static/final_output.mp4",
#             title="[아이포럼]동화 제목",
...
# def get_authenticated_service(credentials: Credentials):
